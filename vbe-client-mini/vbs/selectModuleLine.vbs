...
'' select line
objDocument.VBE.ActiveVBProject.VBComponents(moduleName).Activate
objDocument.VBE.ActiveVBProject.VBComponents(moduleName).CodeModule.CodePane.SetSelection lineCodePane, 1, lineCodePane, 10
